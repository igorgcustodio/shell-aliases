...
Lista de comandos úteis para o dia a dia trabalhando com terminal.
...
DEVELOPMENT_FOLDER | Your folder with Banking projects

## Navigation

Command | Description
:-:|:-:
`development` | Your folder with Banking projects
...
`cleandata` | Clean XCode's derived data
`fixconflict` | Open VSCode to fix conflicts
`updateAliases` | Check new updates to aliases repositories
`aliasHelper` | Open this readme on VSCode